...
import 'package:hackcrisis/model/nodo_item.dart';
import 'package:hackcrisis/util/database_client.dart';
import 'package:hackcrisis/util/date_formatter.dart';
...
class _NotoDoScreenState extends State<NotoDoScreen> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      backgroundColor: Color(0xff372681),
      body: new Column(
          children: <Widget>[
             new Flexible(
