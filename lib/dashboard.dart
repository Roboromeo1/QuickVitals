import 'package:hackcrisis/ui/home.dart';
...
class _MenuDashboardPageState extends State<MenuDashboardPage>
  ...
  List<TransactionDetails> todayTransactionsList = [
    new TransactionDetails(
      item: 'P0123 Has Difficulty Breathing',
      companyName: 'North L2 , Room 334',
      ammount: 2499,
      income: false,
      icon: Icons.person,
    ),
    new TransactionDetails(
      item: 'P0334 Body Temperature rose to 39 C',
      companyName: 'North L3 , Room 400',
      ammount: 499,
      income: true,
      icon: Icons.person,
    ),
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                      image: AssetImage('assets/adhi.png')),
                                ),
                              ),
                            ),
                          ],
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      const ListTile(
                                        ...
                                        title: Text('Pb14201', style: TextStyle(color: Colors.white)),
                                        subtitle: Text('MRI Scan report ', style: TextStyle(color: Colors.white)),
                                      ),
                                        ...
                                        child: ButtonBar(
                                          children: <Widget>[
                                            FlatButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pushNamed(context, LineChartSample8.id);
                                              },
                                            ),
                                            FlatButton(
                                ...
                                child: Card(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      const ListTile(
                                        leading: Icon(Icons.person, size: 70),
                                        title: Text('P102032', style: TextStyle(color: Colors.white)),
                                        subtitle: Text('X Ray Report', style: TextStyle(color: Colors.white)),
                                      ),
                                      // ignore: deprecated_member_use
                                      ButtonTheme.bar(
                                        child: ButtonBar(
                        ...
                        Container(
                          ...
                          child: ListView(
                            ...
                            children: <Widget>[
                              ...
                              transactionList(todayTransactionsList, 'Notifications'),
                              transactionList(
                                  yesterdayTransactionsList, 'Schedule',
                                  lastElement: true),
                            ],
                          ),
                        ),
